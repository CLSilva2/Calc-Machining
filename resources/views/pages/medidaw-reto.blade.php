...
<body class="bg-black text-white min-h-screen">
	...
	<main class="page-content max-w-7xl mx-auto px-4 py-12">
		<h1 class="text-2xl font-bold mb-6 text-white" style="font-family: 'Roboto', sans-serif;">MEDIDA W RETO</h1>
		<p class="text-gray-300">Cálculo da Medida H com dentes retos.</p>
	</main>
