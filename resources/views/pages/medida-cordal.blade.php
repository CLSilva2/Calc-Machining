...
<head>
	...
	<title>Medida Cordal - Calc Machining</title>
...
<body class="bg-black text-white min-h-screen">
	...
	<main class="page-content max-w-7xl mx-auto px-4 py-12">
		<h1 class="text-3xl font-bold mb-6 text-white text-center">Medida Cordal</h1>
		<div class="max-w-4xl mx-auto">
			<p class="text-gray-300 mb-4">Cálculo da Medida Cordal em breve.</p>
		</div>
	</main>
